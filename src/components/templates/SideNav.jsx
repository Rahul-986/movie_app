    ...
    <>
      <div className="w-[20%] h-full border-r-2 border-zinc-400 p-6">
        ...
        <nav className="flex flex-col text-zinc-500 text-lg gap-3">
          ...
          <Link to="/tv" className="hover:bg-[#6556CD] hover:text-white duration-300 p-3 rounded-lg ">
          ...
          <Link to="/person" className="hover:bg-[#6556CD] hover:text-white duration-300 p-3 rounded-lg ">
